...
*   Greek | ΕλληνικάEnglishSpanish | españolFrench | françaisItalian | italianoJapanese | 日本語Korean | 한국어Polish | polskiBrazilian Portuguese | Português brasileiroRomanian | RomâneșteTurkish | TürkçeSimplified Chinese | 简体中文Traditional Chinese | 繁體中文
    ...
    dev (3.16)pre (3.15)3.143.13.133.123.113.103.93.83.73.63.53.43.33.23.13.02.72.6
...
Python 3.13.13 documentation
============================

Welcome! This is the official documentation for Python 3.13.13.
...
Last updated on May 08, 2026 (15:52 UTC). [Found a bug](/bugs.html)?  
